...
Autoboot is set, it executed the commands set in the *environment variable* `bootcmd`. Commands can be separated by semicolon. We've set 2 commands: `ext4load` and `booti`.
```
