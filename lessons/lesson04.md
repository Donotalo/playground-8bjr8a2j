...
U-Boot `v2022.10` won't compile with binutils `v2.39`. The reason and relevant Linux kernel patch can be found [here](https://lore.kernel.org/all/20221002172525.GD3044094@bill-the-cat/t/). To make the compilation work, the file `arch/riscv/Makefile` needs to be updated to the same file as U-Boot `v2023.01`.
```
